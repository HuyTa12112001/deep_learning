...
def get_args():
    ...
    parser.add_argument("--data_path", "-d", type=str, default="data/my_pascal_voc", help="Path to dataset")
    ...
    parser.add_argument("--log_folder", "-p", type=str, default="tensorboard/detection", help="Path to generated tensorboard")
    parser.add_argument("--checkpoint_folder", "-c", type=str, default="trained_models/detection",
